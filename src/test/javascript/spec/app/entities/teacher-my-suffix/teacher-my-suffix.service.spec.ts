...
describe('Service Tests', () => {
    ...
    describe('TeacherMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TeacherMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/teachers/' + 123);
            });
            it('should return TeacherMySuffix', () => {

                let entity: TeacherMySuffix;
                service.find(123).subscribe((_entity: TeacherMySuffix) => {
                    entity = _entity;
                });
