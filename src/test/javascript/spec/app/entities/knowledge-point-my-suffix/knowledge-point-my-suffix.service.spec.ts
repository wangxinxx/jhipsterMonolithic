...
describe('Service Tests', () => {
    ...
    describe('KnowledgePointMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(KnowledgePointMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/knowledge-points/' + 123);
            });
            it('should return KnowledgePointMySuffix', () => {

                let entity: KnowledgePointMySuffix;
                service.find(123).subscribe((_entity: KnowledgePointMySuffix) => {
                    entity = _entity;
                });
