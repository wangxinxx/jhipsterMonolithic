...
describe('Service Tests', () => {
    ...
    describe('StudyHistoryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(StudyHistoryMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/study-histories/' + 123);
            });
            it('should return StudyHistoryMySuffix', () => {

                let entity: StudyHistoryMySuffix;
                service.find(123).subscribe((_entity: StudyHistoryMySuffix) => {
                    entity = _entity;
                });
