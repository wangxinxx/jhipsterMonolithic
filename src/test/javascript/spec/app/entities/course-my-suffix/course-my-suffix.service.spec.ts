...
describe('Service Tests', () => {
    ...
    describe('CourseMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CourseMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/courses/' + 123);
            });
            it('should return CourseMySuffix', () => {

                let entity: CourseMySuffix;
                service.find(123).subscribe((_entity: CourseMySuffix) => {
                    entity = _entity;
                });
