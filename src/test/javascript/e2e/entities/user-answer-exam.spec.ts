...
describe('UserAnswer e2e test', () => {
    ...
    it('should load UserAnswers', () => {
        ...
        expect(userAnswerComponentsPage.getTitle()).toMatch(/jhipsterMonolithicApp.userAnswer.home.title/);
    ...
    it('should load create UserAnswer dialog', () => {
        ...
        expect(userAnswerDialogPage.getModalTitle()).toMatch(/jhipsterMonolithicApp.userAnswer.home.createOrEditLabel/);
