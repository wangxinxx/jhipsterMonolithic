...
describe('BaseQuestion e2e test', () => {
    ...
    it('should load BaseQuestions', () => {
        ...
        expect(baseQuestionComponentsPage.getTitle()).toMatch(/jhipsterMonolithicApp.baseQuestion.home.title/);
    ...
    it('should load create BaseQuestion dialog', () => {
        ...
        expect(baseQuestionDialogPage.getModalTitle()).toMatch(/jhipsterMonolithicApp.baseQuestion.home.createOrEditLabel/);
