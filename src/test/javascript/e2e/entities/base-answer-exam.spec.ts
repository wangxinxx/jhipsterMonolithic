...
describe('BaseAnswer e2e test', () => {
    ...
    it('should load BaseAnswers', () => {
        ...
        expect(baseAnswerComponentsPage.getTitle()).toMatch(/jhipsterMonolithicApp.baseAnswer.home.title/);
    ...
    it('should load create BaseAnswer dialog', () => {
        ...
        expect(baseAnswerDialogPage.getModalTitle()).toMatch(/jhipsterMonolithicApp.baseAnswer.home.createOrEditLabel/);
