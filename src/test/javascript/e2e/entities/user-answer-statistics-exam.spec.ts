...
describe('UserAnswerStatistics e2e test', () => {
    ...
    it('should load UserAnswerStatistics', () => {
        ...
        expect(userAnswerStatisticsComponentsPage.getTitle()).toMatch(/jhipsterMonolithicApp.userAnswerStatistics.home.title/);
    ...
    it('should load create UserAnswerStatistics dialog', () => {
        ...
        expect(userAnswerStatisticsDialogPage.getModalTitle()).toMatch(/jhipsterMonolithicApp.userAnswerStatistics.home.createOrEditLabel/);
