...
public class SubjectResourceIntTest {
    ...
    private static final SubjectState DEFAULT_STATUS = SubjectState.ENABLE;
    private static final SubjectState UPDATED_STATUS = SubjectState.DISABLE;
    ...
    public void createSubject() throws Exception {
        ...
        assertThat(testSubject.getCreateAt()).isEqualTo(DEFAULT_CREATE_AT);
        assertThat(testSubject.getSort()).isEqualTo(DEFAULT_SORT);
    }
    ...
    public void updateSubject() throws Exception {
        ...
        assertThat(testSubject.getCreateAt()).isEqualTo(UPDATED_CREATE_AT);
        assertThat(testSubject.getSort()).isEqualTo(UPDATED_SORT);
    }
